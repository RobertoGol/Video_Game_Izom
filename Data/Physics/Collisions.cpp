...
static float GetMassWeight(PhysicalMassClass massClass) {
    switch (massClass) {
        case PhysicalMassClass::StaticWall:    return 1000000.0f; // Условная бесконечность
        case PhysicalMassClass::VanguardTitan: return 40000.0f;   // 40 тонн
        case PhysicalMassClass::HumanPilot:    return 100.0f;     // 100 кг
        case PhysicalMassClass::VerminSwarm:   return 15.0f;      // 15 кг
        default:                               return 1.0f;
    }
}
